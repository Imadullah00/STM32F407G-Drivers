...
typedef struct
{
	...
	uint32_t RxSize;				// To store receive size
	uint8_t Sr;						//To store repetated start(or not)value
...
#define I2C_FLAG_BTF_      	(1 << I2C_SR1_BTF)
...
void I2C_PeriCLockCOntrol(I2C_RegDef_t *pI2Cx, uint8_t EnorDi);  //DONE
...
/*Data Send & Receive with Interrupt*/
